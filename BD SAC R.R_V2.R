### NOTA: Se debe ejecutar con R de 32 bits!!!!!!!!!!!!!!!!!!
...
## estas conexiones ODBC son de 32 bits

Conexion_1="DATANEW32"
USER_1="dwjamar"
PWD_1="dwjamar"
...
### SE ABRE LA CONEXION ODBC Y SE EJECUTA LA CONSULTA ",Fecha_Inicio," ",Fecha_Fin,"
...
system.time({
  DWJAMAR_Connection =  odbcConnect(Conexion_2, uid = "datamart", pwd = "datamart")
...
rm(list = c("BD_BANCO","BD_QUEJAS","BD_RECLAMOS","BD_RETAIL",
            "Fecha_Inicio","Fecha_Fin","Fecha_Inicio_Banco","VectorFecha",
            "VectorFechaBanco","ESTRATOS","N","n","DWJAMAR_Connection"))
